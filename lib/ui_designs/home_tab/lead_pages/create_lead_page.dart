...
class CreateLeadPage extends StatefulWidget {
  final LeadDetails? createLead;
  const CreateLeadPage({Key? key, this.createLead}) : super(key: key);
...
class _CreateLeadPageState extends State<CreateLeadPage> {
  ...
  void initState() {
    super.initState();
    getCompanyType();
    if(widget.createLead!=null){
      createLead=LeadDetails.fromJson(widget.createLead!.toJson());
      if(widget.createLead?.gstLicenceCertificate !=null){
        for (var element in widget.createLead!.gstLicenceCertificate!) {
          gstLicenseImageList.add(element);
        }
      }
      if(widget.createLead?.drugLicenceCertificate !=null){
        for (var element in widget.createLead!.drugLicenceCertificate!) {
          drugLicenseImageList.add(element);
        }
      }
      areaController.text=widget.createLead!.townId!.townName;
    }
    else{
      createLead=LeadDetails(id: "");
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(title: widget.createLead !=null ?"Edit Lead": "Create Lead",implyStatus: true),
      body: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                CustomTextFormField(
                  ...
                  onSaved: (val)=>createLead?.customerName=val,
                  initialValue: createLead?.customerName,
                ...
                CustomTextFormField(
                  ...
                  onSaved: (val)=>createLead?.gstNumber=val,
                  initialValue: createLead?.gstNumber,
                ),
                ...
                CustomTextFormField(
                  ...
                  onSaved: (val)=>createLead?.drugLicenceNumber=val,
                  initialValue: createLead?.drugLicenceNumber,
                ),
                ...
                CustomTextFormField(
                  ...
                  textCapitalization: TextCapitalization.words,
                  onSaved: (val)=>createLead?.contactPersonName=val,
                  initialValue: createLead?.contactPersonName,
                ...
                CustomTextFormField(
                  ...
                  onSaved: (val)=>createLead?.contactPersonMobileNumber=val,
                  initialValue: createLead?.contactPersonMobileNumber,
                ...
                CustomTextFormField(
                  ...
                  onSaved: (val)=>createLead?.designation=val,
                  textCapitalization: TextCapitalization.words,
                  initialValue: createLead?.designation,
                ),
                CustomTextFormField(
                  hintText: "Enter qualification", labelText: "Qualification",
                  onSaved: (val)=>createLead?.qualification=val,
                  initialValue: createLead?.qualification,
                  textCapitalization: TextCapitalization.words,
                ...
                CustomTextFormField(
                    ...
                    inputFormatters: [FilteringTextInputFormatter.digitsOnly],
                    keyboardType: TextInputType.number,
                    onSaved: (val)=>createLead?.companyMobileNumber=val,
                    initialValue: createLead?.companyMobileNumber,
                    maxLength: 10),

                CustomTextFormField(
                  hintText: "Enter email", labelText: "Company Email ID",
                  onSaved: (val)=>createLead?.companyEmailId=val,
                  initialValue: createLead?.companyEmailId,
                  keyboardType: TextInputType.emailAddress,
                ),
                CustomTextFormField(
                  hintText: "Enter address", labelText: "Address 1*",
                  onSaved: (val)=>createLead?.address1=val,
                  textCapitalization: TextCapitalization.words,

                  initialValue: createLead?.address1,
                  validator: (val){
                    if(val!=null && val.isNotEmpty){
                      return null;
                    }
                ...
                CustomTextFormField(
                  ...
                  onSaved: (val)=>createLead?.address2=val,
                  initialValue: createLead?.address2,
                  textCapitalization: TextCapitalization.words,
                ...
                CustomTextFormField(
                  ...
                  onSaved: (val)=>createLead?.address3=val,
                  textCapitalization: TextCapitalization.words,

                  initialValue: createLead?.address3,
                ),
                CustomTextFormField(
                  hintText: "Enter city", labelText: "City*",
                  onSaved: (val)=>createLead?.city=val,
                  initialValue: createLead?.city,
                  textCapitalization: TextCapitalization.words,
                  validator: (val){
                    if(val!=null && val.isNotEmpty){
                      return null;
                ...
                CustomTextFormField(
                  ...
                  onSaved: (val)=>createLead?.state=val,
                  textCapitalization: TextCapitalization.words,

                  initialValue: createLead?.state,
                  validator: (val){
                    if(val!=null && val.isNotEmpty){
                      return null;
                    }
                ...
                CustomTextFormField(
                  ...
                  keyboardType: TextInputType.number,
                  onSaved: (val)=>createLead?.pinCode=val,
                  initialValue: createLead?.pinCode,
                  validator: (val){
                    if(val!=null && val.isNotEmpty){
                      return null;
                    }
                                                    ...
                                                    onTabButtonCallback:
                                                      ...
                                                      if (selectedBrand != null) {
                                                        ...
                                                        var response = await showModalBottomSheet(
                                                            ...
                                                            true,
                                                            builder: (context) {
                                                              return ProductListSheet(brandId: selectedBrand!.id!,selectedProducts: createLead?.products);
                                                            });
                                                        setState(() {
                                                          if(response!=null){
                                                            createLead?.products=response;
                                                            print(response);
                                                          }
                                                        });
                ...
                if(createLead?.products!=null && createLead!.products!.isNotEmpty)
                  selectedProductTable(createLead!.products!),
                ...
                CustomTextFormField(
                  ...
                  onSaved: (val)=>createLead?.notes=val,
                  initialValue: createLead?.notes,
                ...
                CustomButton(title: widget.createLead !=null ?"Update": "Create",onTabButtonCallback: onCreateClick),
              ],
            ),
          ),
        ),
      ...
      child: DropdownButtonFormField(
        ...
        onChanged: (val){
          ...
          if(companyTypeId!=null) {
            createLead?.customerTypeId=companyTypeId!;
          }
        },
      ),
    ),
  ...
  Future<void> getCompanyType() async {
    ...
    if(response.status){
      ...
      if(widget.createLead?.customerTypeId!=null){
        companyTypeId = companyList.firstWhere((element) => element.id == widget.createLead?.customerTypeId?.id);
      }
      setState(() {
  ...
  Future<void> onCreateClick() async {
    if(await InternetUtil.isInternetConnected()){
      ...
      if(createLead?.customerTypeId!=null){
        if(createLead?.products!=null && createLead!.products!.isNotEmpty){
          try{
              ...
              for(int i=0;i<gstLicenseImageList.length;i++){
                ...
                if(gstLicenseImageList[i].runtimeType == String){
                  ...
                  if(path.lengthInBytes > 1000000) {
                    ...
                    var temp = await data.uploadBytesToFirebase("Lead/GSTCertificate/${DateTime.now().millisecondsSinceEpoch}.jpg");
                    imageUploadFileGST.add(temp);
                  }
                  else{
                    var temp = await path.uploadBytesToFirebase("Lead/GSTCertificate/${DateTime.now().millisecondsSinceEpoch}.jpg");
                    imageUploadFileGST.add(temp);
                  }
              ...
              for(int i=0;i<drugLicenseImageList.length;i++){
                ...
                if(drugLicenseImageList[i].runtimeType == String){
                  ...
                  if(path.lengthInBytes > 1000000) {
                    ...
                    var temp = await data.uploadBytesToFirebase("Lead/DrugCertificate/${DateTime.now().millisecondsSinceEpoch}.jpg");
                    imageUploadFileDrug.add(temp);
                  }
                  else{
                    var temp = await path.uploadBytesToFirebase("Lead/DrugCertificate/${DateTime.now().millisecondsSinceEpoch}.jpg");
                    imageUploadFileDrug.add(temp);
                  }
                }
            ...
            createLead?.gstLicenceCertificate = imageUploadFileGST;
            createLead?.drugLicenceCertificate = imageUploadFileDrug;


            String userId= await SessionManager.getUserId();
            print("Body going is : ${createLead!.getJsonOnlyKey(locationController.latitude.value,locationController.longitude.value,userId,false)}");


            var response = await LeadRepo.createLead(createLead!.getJsonOnlyKey(locationController.latitude.value,locationController.longitude.value,userId,false));
            if(response.status){
              Get.back(result: true);
              context.showSnackBar(widget.createLead !=null ?"Lead Detials Updated":"Lead Created Successfully", null);
              Get.off(LeadDetailsPage(leadId: response.data,fromCreatePage: true));
            }
          }
          catch(e,stack){
            debugPrint("Error : $e \n $stack");
