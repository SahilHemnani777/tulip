...
class ExpenseFilterPage extends StatefulWidget {
  ...
  const ExpenseFilterPage({Key? key, this.selectedFilter, required this.updateFilterVisibilityCallback, required this.applyFilterCallback}) : super(key: key);
...
class _ExpenseFilterPageState extends State<ExpenseFilterPage> {
  ...
  void initState() {
    ...
    if (widget.selectedFilter != null) {
      ...
      _created = widget.selectedFilter?[0].contains('Created');
