...
class DateUtil {
  ...
  static final _displayFormatDateTimeAMFormat = DateFormat('yyyy-MM-dd HH:mm:ss');
  static final _displayFormatDateTimeFormatDashed = DateFormat('yyyy-MM-dd hh:mm:ss');
  ...
  static final _onlyDateFormator = DateFormat('dd');
  static final _weekDayFormator = DateFormat('EEEE');
  static final _weekDay3Formator = DateFormat('EEE');
  static final _monthOfYearFormator = DateFormat('MMM');

  static final _serverFormatDate = DateFormat('yyyy-MM-dd');
  static final _serverFormatDateTimeFormat = DateFormat('''yyyy-MM-dd HH:mm:ss''');
  ...
  static String getDisplayFormatAMDateTime(DateTime dateTime) {
    return _displayFormatDateTimeAMFormat.format(dateTime);
  }
...
//    return getDisplayFormatDateTime(dateTime);
    ...
    if (timeDifference < 24) {
      if (timeDifference <= 0) return '${differenceDuration.inMinutes} मिनिटे अगोदर';
  ...
  static String getOnlyDateFormator(DateTime dateTime) {
    return _onlyDateFormator.format(dateTime);
  }

  static String getWeekDayFormator(DateTime dateTime) {
    return _weekDay3Formator.format(dateTime);
  }

  static String getMonthOfYearFormator(DateTime dateTime) {
    return _monthOfYearFormator.format(dateTime);
  }
}
